...
for frame in range(0, 5000, 50):
    ...
    vp.render_image(
        filename="./ovito_png_files/myimage_%05d.png" % frame,
        size=(480, 480),
        frame=frame,
    )
...
metad_png_files = os.listdir(
    "../../Metadynamics/vasp_codes/output_LLTO_U1_MetaD_2000K_H01_W01_BIN50"
)
...
for i in range(len(ovito_png_files)):
    ...
    images = [
        Image.open(
            "../../old_metadynamics/vasp_codes/output_LLTO_U1_MetaD_2000K_H01_W01_BIN50/"
            + metad_png_files[i]
        ),
